...
import { TasksBulkActions } from '@/components/TasksBulkActions.tsx';
...
export const Tasks = ({ searchInput, onSearchChange }: Props) => {
  ...
  return (
    ...
    >
      ...
      {selectedCount > 0 && (
        <TasksBulkActions
          areAllSelectedTasksCompleted={areAllSelectedTasksCompleted}
          ...
          onOpenDateMenu={(event) => setDateMenuAnchor(event.currentTarget)}
          onOpenTagMenu={(event) => setTagMenuAnchor(event.currentTarget)}
